...
export const columns: ColumnDef<Exam>[] = [
  {
    ...
    header: "Exam Name",
    cell: ({ row }) => <div className="capitalize">{row.getValue("examName")}</div>,
  },
  {
    accessorKey: "module",
    header: "Module",
  ...
  },
  {
    ...
    header: "Total Marks",
    cell: ({ row }) => <div className="capitalize">{row.getValue("totalMarks")}</div>,
  },
  {
    id: "actions",
    enableHiding: false,
    ...
    <div className="w-full">
      <div className="flex items-center justify-between py-4">
        <Input
          ...
          value={(table.getColumn("examName")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
