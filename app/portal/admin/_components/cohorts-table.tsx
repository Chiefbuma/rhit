      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>Delete Cohort</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
    },
    ...
    <div className="w-full">
      <div className="flex items-center justify-between py-4">
        <Input
          ...
          value={(table.getColumn("cohortName")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("cohortName")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
