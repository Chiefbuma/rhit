...
// Validate ../../app/api/portal/state/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/portal/state">> = Specific
  const handler = {} as typeof import("../../app/api/portal/state/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
